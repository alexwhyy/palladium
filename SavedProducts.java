...
public abstract class SavedProducts {
   ...
   /*
    * Name: removeProduct Purpose: Removes select product from a list Description:
    * passes in ArrayList and the index of the array to be removed
    */
   ...
   /*
    * Name: removeAllProduct Purpose: Removes all products from a list Description:
    * passes in ArrayList to be cleared
    */
   ...
   /*
    * Name: sortProduct Purpose: sorts a list depending on user specifications
    * Description: passes in String to determine sorting method and the ArrayList
    * to be sorted
    */
   ...
   /*
    * Name: recursiveSortName Purpose: Recursively sorts a list by name
   ...
   /*
    * Name: recursiveSortRetailer Purpose: Recursively sorts a list by retailer
    * Description: passes in ArrayList to be sorted and count to recursively sort
    */
   ...
   /*
    * Name: recursiveSortId Purpose: Recursively sorts a list by product id
    * Description: passes in ArrayList to be sorted and count to recursively sort
    */
   ...
   /*
    * Name: recursiveSortPrice Purpose: Recursively sorts a list by price
    * Description: passes in ArrayList to be sorted and count to recursively sort
    */
   ...
   /*
    * Name: recursiveSortSalePercent Purpose: Recursively sorts a list by products
    * on sale Description: passes in ArrayList to be sorted and count to
    * recursively sort
    */
